    ...
    <Pane>
      ...
      <Pane.Content>
          ...
          <thead>
            <tr>
              {['Period', 'Start', '', 'End'].map((h, i) => (
                <th
                  key={i}
                  className='text-[#555] font-bold text-left pb-1 text-[11.5px] border-b border-[#e0e0e0]'
                >
                  {h}
                </th>
              ))}
          ...
          <tbody>
            {enrollment.phases.map((phase, i) => (
              <tr key={i}>
                ...
                <td className='py-[3px] pl-[3px] text-[#666] text-[11px]'>
                  {phase.startTime}
                </td>
        ...
        <table className='w-full border-collapse text-[12px] mb-3'>
          <thead>
            <tr>
              <th className='text-[#555] font-bold text-left pb-1 text-[11.5px] border-b border-[#e0e0e0]'>
                Deadline
              </th>
              <th className='text-[#555] font-bold text-right pb-1 text-[11.5px] border-b border-[#e0e0e0]'>
                Deadline Date
              </th>
            </tr>
          </thead>
            ...
            {enrollment.deadlines.map((deadline, i) => (
              <tr key={i}>
                ...
                <td className='py-[3px] text-right text-[#555]'>
                  {deadline.date}{' '}
                  <span className='text-[11px]'>{deadline.time}</span>
                </td>
              </tr>
            ))}
          </tbody>
        ...
        <a href='#' className='text-[#1971c2] text-[12px] block mt-1'>
          Learn More About Enrollment ∨
        </a>

        {/* Final exams */}
        <div className='text-sm font-bold text-[#212121] mt-[14px] mb-[5px]'>
          Final Exam Schedule
        </div>
