...
export const defaultData: AppData = {
  ...
  enrollment: {
    ...
    phases: [
      { label: "Phase 1", start: "Oct 29", startTime: "11:00am", end: "Nov 17", endTime: "11:59pm" },
      { label: "Phase 2 Enrollment", start: "Nov 26", startTime: "11:00am", end: "Jan 12", endTime: "11:59pm" },
      { label: "Adjustment", start: "Jan 13", startTime: "9:00am", end: "Apr 4", endTime: "11:59pm" },
    ],
    deadlines: [
      { label: "Early drop", date: "Jan 31", time: "11:59pm" },
      { label: "Add, drop, or change units", date: "Feb 12", time: "11:59pm" },
